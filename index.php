...
<html lang="en">
	<head>
		<!-- Meta -->
		<meta chaTshset="utf-8">
		<meta http-equiv="Content-Type" content="text/html; chaTshset=UTF-8">
...
<div id="hero" class="homepage-slider3">
	...
	<div class="full-width-slider">
			...
			<img src="assets/images/sliders/team4.jpg" alt="">
			</div><!-- /.item -->
		</div>
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/fur1.jpg);">
				<!-- /.container-fluid -->
				<img src="assets/images/sliders/team1.jpg" alt="">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/fur1.jpg);">
			<img src="assets/images/sliders/team2.jpg" alt="">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/fur1.jpg);">
			<img src="assets/images/sliders/team3.jpg" alt="">
			</div><!-- /.item -->
		</div>
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Quick Delivery</h4>
						</div>
					</div>	
					<h6 class="text">Ndani ya muda mchache unapokea Order yako</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">kwa Dar es salaam Mzigo unasafirisha bure</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Pata Bidhaa zako katika bei ya punguzo </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Bidhaa Mpya</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">All</a></li>
					<li><a href="#man" data-toggle="tab">Men</a></li>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					Tshs<?php echo htmlentities($row['productPrice']);?>			</span>
										     <span class="price-before-discount">Tshs<?php echo htmlentities($row['productPriceBeforeDiscount']);?>	</span>
									
			</div><!-- /.product-price -->
			
		</div><!-- /.product-info -->
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">+<i class="glyphicon glyphicon-shopping-cart"></i></a></div>
			</div><!-- /.product -->
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Unisex</h3>
								...
								<div class="row product-micro-row">
									...
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price">
													Tshs <?php echo htmlentities($row['productPrice']);?>
												</span>
