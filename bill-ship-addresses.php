...
header('location:index.php');
	...
	// code for pickup address updation
	if(isset($_POST['update']))
	{
		$wilaya=$_POST['wilaya'];
		$pickup=$_POST['pickup'];
		$query=mysqli_query($con,"update users set Wilaya='$wilaya',pickupAddress='$pickup' where id='".$_SESSION['id']."'");
		if($query)
		{
echo "<script>alert('Umefanikiwa kubadili Pickup Address yako');</script>";
		}
	}
...
<div class="form-group">
					    <label class="info-title" for="wilaya">Wilaya/District<span>*</span></label>
					    <textarea class="form-control unicase-form-control text-input" " name="wilaya" required="required"><?php echo $row['Wilaya'];?></textarea>
					  </div>



						<div class="form-group">
					    <label class="info-title" for="pickup ">Pickup Address  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="pickup" name="pickup" value="<?php echo $row['pickupAddress'];?>" required>
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="City">City</label>
					    <input type="text" class="form-control unicase-form-control text-input" id="billingcity" name="city" required="required" value="<?php echo $row['Jiji'];?>" readonly >
					  </div>
